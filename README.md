...
Senior Software Engineer focused on backend systems, API platforms, and full-stack products with Python, Django, FastAPI, React, Docker, and cloud infrastructure.

I build production-style web systems: REST APIs, authentication flows, database-backed products, background workers, integrations, admin dashboards, and React interfaces. My strongest work is in Python backend engineering with practical full-stack delivery when the product needs it.

## Core Stack

- **Backend:** Python, Django, Django REST Framework, FastAPI, Flask
- **Frontend:** React, TypeScript, JavaScript, Tailwind CSS, Redux Toolkit
- **Data:** PostgreSQL, SQLite, MySQL, MongoDB, query optimization, indexing
- **Async and realtime:** Celery, Redis, WebSockets
- **Cloud and DevOps:** Docker, Linux, GitHub Actions, AWS EC2, S3, RDS, CloudFront
- **Integrations:** JWT, OAuth2, Stripe, OpenAI/LLM APIs, third-party APIs, OpenSearch

## What I Build

- Backend APIs with clear service boundaries and practical documentation
- Multi-tenant SaaS-style workflows
- Authentication, authorization, and role-based access systems
- Background processing with Celery and Redis
- Database-backed dashboards and reporting workflows
- React frontends connected to real API contracts
- Dockerized development and deployment workflows
- Cloud-ready applications with environment-driven configuration
